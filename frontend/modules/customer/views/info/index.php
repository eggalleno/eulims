    ...
    <div class="table-responsive">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<span class="glyphicon glyphicon-book"></span>  ' . Html::encode($this->title),
                'before'=>"<button type='button' onclick='LoadModal(\"Create New Customer\",\"/customer/info/create\")' class=\"btn btn-success\"><i class=\"fa fa-plus-o\"></i> Create Customer</button>",
            ],
            'columns' => [
