 ...
 */
class AccomplishmentOverall extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['yeardata'], 'integer'],
            [['indicator', 'type'], 'string', 'max' => 30],
            [['indicator_desc'], 'string', 'max' => 200],
            [['total', 'totalrstl', 'totalrdi', 'region1', 'region2', 'region3', 'region4', 'region4L1', 'region4L2', 'region4L3', 'region4L4', 'region4b', 'region5', 'region6', 'region7', 'region8', 'region9', 'region10', 'region11', 'region12', 'region12L1', 'region12L2', 'caraga', 'car', 'barmm', 'itdi', 'fprdi', 'fnri', 'mirdc', 'pnri', 'ptri'], 'string', 'max' => 20],
        ];
    }
